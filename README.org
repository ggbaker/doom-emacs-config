...
- [[#general-configuration][General configuration]]
  ...
  - [[#theme-and-buffer-appearance][Theme and buffer appearance]]
  - [[#technical-stuff][Technical stuff]]
  - [[#global-keybindings][Global keybindings]]
  - [[#searching][Searching]]
- [[#org-setup][Org setup]]
  - [[#todo-1][Todo]]
  - [[#buffer-appearance][Buffer appearance]]
...
- [[#latex-setup][LaTeX setup]]
  - [[#buffer-appearance-1][Buffer appearance]]
  - [[#basic-formatting][Basic formatting]]
  - [[#inserting-environments][Inserting environments]]
  - [[#compiling-and-viewing][Compiling and viewing]]
  - [[#pdf-viewer][PDF viewer]]
  - [[#citation-management-1][Citation management]]
  - [[#company-backend-fix][Company backend fix]]
- [[#citation-management-2][Citation management]]
